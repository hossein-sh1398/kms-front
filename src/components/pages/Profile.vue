                    ...
                    <div class="card">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" v-model.lazy="formData.phone" placeholder="شماره موبایل خود را وارد کنید" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" v-model.lazy="formData.email" placeholder="آدرس ایمیل خود را وارد کنید" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" style="resize:none" v-model.lazy="formData.address" rows="2" placeholder="نشانی"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" style="resize:none" v-model.lazy="formData.about" rows="4" placeholder=""></textarea>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-footer text-left">
                            ...
                            <button type="submit" v-else @click.prevent="updateProfile"
                                class="btn btn-primary waves-effect waves-light">بروزرسانی پروفایل</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" v-model.lazy="formPasswordData.oldPassword"
                                                placeholder="پسورد خود را وارد کنید" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" v-model.lazy="formPasswordData.newPassword"
                                                placeholder="پسورد جدید خود را وارد کنید" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" v-model.lazy="formPasswordData.confirmPassword" placeholder="تکرار پسورد جدید خود را وارد کنید" type="text">
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-footer text-left">
                            ...
                            <button type="submit" v-else @click.prevent="updatePassword"
                                class="btn btn-primary waves-effect waves-light">بروزرسانی پسورد</button>
                        </div>
                    </div>
                </div>
            </div>
